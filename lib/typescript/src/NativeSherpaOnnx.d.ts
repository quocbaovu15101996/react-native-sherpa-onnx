...
export interface Spec extends TurboModule {
     ...
     */
    transcribeFile(instanceId: string, filePath: string): Promise<{
        text: string;
        tokens: string[];
        timestamps: number[];
        lang: string;
     ...
     */
    transcribeSamples(instanceId: string, samples: number[], sampleRate: number): Promise<{
        text: string;
        tokens: string[];
        timestamps: number[];
        lang: string;
    ...
    acceptSttWaveform(streamId: string, samples: number[], sampleRate: number): Promise<void>;
     ...
     */
    processSttAudioChunk(streamId: string, samples: number[], sampleRate: number): Promise<{
        text: string;
        tokens: string[];
        timestamps: number[];
        isEndpoint: boolean;
     ...
     */
    detectTtsModel(modelDir: string, modelType?: string): Promise<{
        success: boolean;
        /** Present when success is false (or native included a message). */
        error?: string;
        detectedModels: Array<{
     ...
     */
    generateTts(instanceId: string, text: string, options: Object): Promise<{
        samples: number[];
        sampleRate: number;
    }>;
    /**
     ...
     */
    generateTtsWithTimestamps(instanceId: string, text: string, options: Object): Promise<{
        samples: number[];
        sampleRate: number;
        subtitles: Array<{
            text: string;
     ...
     */
    generateTtsStream(instanceId: string, requestId: string, text: string, options: Object): Promise<void>;
    /**
    ...
    detectEnhancementModel(modelDir: string, modelType?: string): Promise<{
        success: boolean;
        error?: string;
        detectedModels: Array<{
            type: string;
    ...
    initializeEnhancement(instanceId: string, modelDir: string, modelType?: string, numThreads?: number, provider?: string, debug?: boolean): Promise<{
        success: boolean;
        error?: string;
        detectedModels: Array<{
            type: string;
    ...
    enhanceFile(instanceId: string, inputPath: string, outputPath?: string): Promise<{
        samples: number[];
        sampleRate: number;
    }>;
    enhanceSamples(instanceId: string, samples: number[], sampleRate: number): Promise<{
        samples: number[];
        sampleRate: number;
    }>;
    getEnhancementSampleRate(instanceId: string): Promise<number>;
    unloadEnhancement(instanceId: string): Promise<void>;
    initializeOnlineEnhancement(instanceId: string, modelDir: string, modelType?: string, numThreads?: number, provider?: string, debug?: boolean): Promise<{
        success: boolean;
        error?: string;
        sampleRate?: number;
        frameShiftInSamples?: number;
    }>;
    feedEnhancementSamples(instanceId: string, samples: number[], sampleRate: number): Promise<{
        samples: number[];
        sampleRate: number;
    }>;
    flushOnlineEnhancement(instanceId: string): Promise<{
        samples: number[];
        sampleRate: number;
    }>;
     ...
     */
    saveTtsAudioToFile(samples: number[], sampleRate: number, filePath: string): Promise<string>;
    /**
     ...
     */
    saveTtsAudioToContentUri(samples: number[], sampleRate: number, directoryUri: string, filename: string): Promise<string>;
    /**
     ...
     * @returns The content URI of the saved file
     */
    saveTtsTextToContentUri(text: string, directoryUri: string, filename: string, mimeType: string): Promise<string>;
    /**
     ...
     */
    copyFileToContentUri(filePath: string, directoryUri: string, filename: string, mimeType: string): Promise<string>;
    /**
     ...
     */
    listModelsAtPath(path: string, recursive: boolean): Promise<Array<{
        folder: string;
        hint: 'stt' | 'tts' | 'unknown';
    }>>;
    /**
     ...
     */
    decodeAudioFileToFloatSamples(inputPath: string, targetSampleRateHz?: number): Promise<{
        samples: number[];
        sampleRate: number;
    }>;
    /**
